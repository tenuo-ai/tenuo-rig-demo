...
The tests execute the complete scripted flow and assert Rig argument denials, model-visible refusal details, peer isolation, non-widening delegation, independent MCP verification, and server-side rejection of bypass attempts.
